...
const AboutGame = () => {
    ...
    return (
        <section className="relative py-16 md:py-32 bg-[#050505] text-white overflow-hidden text-center">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                <h4 className="text-[#ff3333] text-xs md:text-sm tracking-[0.3em] uppercase mb-3 md:mb-4 font-bold">
                    {about.subtitle}
                </h4>
                <h2 className="text-3xl md:text-6xl font-godlike uppercase tracking-wider mb-6 md:mb-8 text-white">
                    {about.title}
                </h2>
                ...
                {/* Stats Row */}
                <div className="grid grid-cols-3 gap-6 md:gap-12 border-t border-b border-white/5 py-8 md:py-12">
                    {about.statistics.map((stat, i) => (
                        <div key={i} className="space-y-2">
                            <div className="text-3xl md:text-5xl font-godlike text-white">{stat.number}</div>
