...
import bgImage from '../../assets/shot2.webp'; // Consistent background
                            ...
                            {cartItems.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className="w-full sm:w-28 md:w-32 h-32 sm:h-36 md:h-40 bg-black/50 rounded-lg overflow-hidden flex-shrink-0 border border-white/5 mx-auto sm:mx-0">
                                        <img src={item.image} alt={item.name} className="w-full h-full object-cover mix-blend-lighten opacity-80 group-hover:opacity-100 transition-opacity" />
                                    </div>
